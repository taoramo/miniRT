...
int	main(void)
{
	...
	m.spheres[1].texture_type = checker;
	...
	m.cylinders[0].height = 0.5;
	m.cylinders[0].radius = 0.25;
	m.cylinders[0].albedo = init_vec3(0.8, 0.8, 0.8);
	m.cylinders[0].material = lambertian;
	m.cylinders[0].material1 = 0;
	m.cylinders[0].texture_type = checker;
	m.cylinders[0].checker_size_coeff = 8;
